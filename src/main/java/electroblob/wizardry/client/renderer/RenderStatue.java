...
public class RenderStatue extends TileEntitySpecialRenderer<TileEntityStatue> {
	...
	@Override
	public void render(TileEntityStatue statue, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		...
		if(statue.creature != null && statue.position == 1){
			...
			// TODO: check if this is the case in 1.12
